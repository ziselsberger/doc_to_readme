...
| [doc_to_md](./src/doc_to_md/doc_to_md.py) | function  | `update_markdown_file(file: str = "../README.md", root_dir: str = None, exclude_modules: Tuple[str, ...] = (), specified_modules: Optional[Tuple[str, ...]] = None)` | Add/update 'Functions & Classes' Section in Markdown file. |
